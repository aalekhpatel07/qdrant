...
EXPORT uint32_t impl_xor_popcnt_scalar8_neon_uint128(
    ...
    for (uint32_t _i = 0; _i < count; _i++) {
        ...
        uint8x16_t q2 = vld1q_u8(q_ptr + 2);
        uint8x16_t q3 = vld1q_u8(q_ptr + 4);
        uint8x16_t q4 = vld1q_u8(q_ptr + 6);
        uint8x16_t q5 = vld1q_u8(q_ptr + 8);
        uint8x16_t q6 = vld1q_u8(q_ptr + 10);
        uint8x16_t q7 = vld1q_u8(q_ptr + 12);
        uint8x16_t q8 = vld1q_u8(q_ptr + 14);

        uint8x16_t x1 = veorq_u8(q1, v);
        uint8x16_t x2 = veorq_u8(q2, v);
        uint8x16_t x3 = veorq_u8(q3, v);
        uint8x16_t x4 = veorq_u8(q4, v);
        uint8x16_t x5 = veorq_u8(q5, v);
        uint8x16_t x6 = veorq_u8(q6, v);
        uint8x16_t x7 = veorq_u8(q7, v);
        uint8x16_t x8 = veorq_u8(q8, v);
