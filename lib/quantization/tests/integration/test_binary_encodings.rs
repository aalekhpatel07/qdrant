...
mod tests {
    ...
    fn test_binary_dot_inverted_asymetric() {
        test_binary_dot_asymentric_impl::<u128>(700, Encoding::OneBit, true);
        test_binary_dot_asymentric_impl::<u8>(700, Encoding::OneBit, true);

        test_binary_dot_asymentric_impl::<u128>(700, Encoding::OneAndHalfBits, true);
        test_binary_dot_asymentric_impl::<u8>(700, Encoding::OneAndHalfBits, true);

        test_binary_dot_asymentric_impl::<u128>(700, Encoding::TwoBits, true);
        test_binary_dot_asymentric_impl::<u8>(700, Encoding::TwoBits, true);
    }
